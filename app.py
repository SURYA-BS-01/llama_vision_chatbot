...
# # Streamlit App
# st.set_page_config(page_title="AI OCR Extractor", page_icon="📄", layout="wide")

# # Sidebar
# st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/OCR-A_characters.svg/800px-OCR-A_characters.svg.png", width=200)
# st.sidebar.title("AI OCR Extractor")
# st.sidebar.markdown("Extract text from images using Groq’s Vision model.")
...
#     # Download button
#     st.download_button("📥 Download Text", extracted_text, file_name="extracted_text.txt", mime="text/plain")
...
#     # Use HuggingFace for free text embeddings
#     embeddings = HuggingFaceEmbeddings(model_name="sentence-transformers/all-MiniLM-L6-v2")

#     # Store extracted text in ChromaDB
#     db = Chroma.from_texts([extracted_text], embeddings)
#     retriever = db.as_retriever()

#     # Create a memory for conversation history
#     memory = ConversationBufferMemory(memory_key="chat_history", return_messages=True)

#     # Initialize LangChain QA Chat Model
...
#     # Chat interface
#     st.subheader("Ask Questions About the Extracted Text 🗨️")
...
#     # User input
#     query = st.chat_input("Ask something about the extracted text...")
